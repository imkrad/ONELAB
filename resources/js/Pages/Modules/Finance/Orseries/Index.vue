<template>
    <PageHeader title="OR Series" pageTitle="List" />
                ...
                <table class="table table-nowrap align-middle mb-0">
                    <thead class="table-light">
                        <tr class="fs-11">
                            ...
                            <th style="width: 15%;" class="text-center">Start</th>
                            <th style="width: 15%;" class="text-center">Next</th>
                            <th style="width: 15%;" class="text-center">End</th>
