                    ...
                    <div>
                        <BRow class="g-3">
                            ...
                            <BCol lg="12" class="mt-0">
                                ...
                                <Multiselect :options="dropdowns.laboratories" v-model="form.laboratory_id" :message="form.errors.laboratory_id" label="name" placeholder="Select Laboratory" ref="multiselect1"/>
                            </BCol>
                            <BCol :lg="(has_lab) ? 6 : 12" class="mt-1">
                                <InputLabel for="role" value="Role" />
                                <Multiselect :options="dropdowns.roles" v-model="form.role" object :message="form.errors.role_id" label="name" placeholder="Select Role" ref="multiselect2"/>
                            </BCol>
                            <BCol lg="6" v-if="has_lab" class="mt-1">
                                <InputLabel for="laboratory_type" value="Laboratory type" />
                                <Multiselect :options="dropdowns.types" v-model="form.laboratory_type" :message="form.errors.laboratory_type" label="name" placeholder="Select Laboratory type" ref="multiselect3"/>
                            </BCol>
