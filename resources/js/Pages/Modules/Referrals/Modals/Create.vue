<template>
    <b-modal v-model="showModal" style="--vz-modal-width: 850px;" header-class="p-3 bg-light" :title="(!editable) ? 'Create Referral' : 'Edit Referral'" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>
        <form class="customform">
            <BRow class="g-3">
                ...
                <BCol lg="12">
                    <hr class="text-muted mt-0 mb-n4"/>
                </BCol>
                ...
                <BCol lg="12" class="mt-1">
                    <InputLabel for="due" value="Sample" :message="form.errors.conforme"/>
                    <TextInput type="text" class="form-control" autofocus placeholder="Please enter name"  :light="true"/>
                </BCol>
            </BRow>
        </form>
