        ...
        <form class="customform">
            <BRow class="g-3 mt-1">
                ...
                <BCol lg="12" class="mt-0 mb-n1" v-if="selected.name != 'Leave'"> 
                    ...
                    <TextInput id="name" v-model="form.title" type="text" class="form-control" autofocus placeholder="Please enter title" autocomplete="name" required :class="{ 'is-invalid': form.errors.name }" @input="handleInput('name')" :light="true"/>
                </BCol>
                <BCol lg="12" class="mt-1 mb-n1" v-if="selected.type == 'official'">
                    <InputLabel for="name" value="Venue" :message="form.errors.name"/>
                    <TextInput id="name" v-model="form.venue" type="text" class="form-control" autofocus placeholder="Please enter venue" autocomplete="name" required :class="{ 'is-invalid': form.errors.name }" @input="handleInput('name')" :light="true"/>
                </BCol>
