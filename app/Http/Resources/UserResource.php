...
class UserResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'assigned_role_id' => ($this->userrole) ? $this->userrole->role : 'n/a',
            'assigned_lab' => ($this->userrole) ? $this->userrole->role->is_lab : 'n/a',
            'assigned_laboratory' => ($this->userrole) ? $this->userrole->laboratory->name : 'n/a',
            'assigned_laboratory_id' => ($this->userrole) ? $this->userrole->laboratory->id : 'n/a',
            'assigned_type' => ($this->userrole) ? ($this->userrole->type) ? $this->userrole->type->name : 'n/a' : 'n/a',
            'assigned_type_id' => ($this->userrole) ? ($this->userrole->type) ? $this->userrole->type->id : 'n/a' : 'n/a',
